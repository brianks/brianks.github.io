...
- *Getting started with ES2015 and Meteor* - *Set up Sublime Text for ES2015* - *How much does ES2015 cost?* 
...
* Babel (for syntax highlighting – *full instructions* * SublimeLinter (*full instructions* * SublimeLinter-contrib-eslint (*full instructions* 
...
A side note for Emmet users: You can use *\<ctrl-e\>* to expand HTML tags in .jsx files, and it will correctly expand classes to React's "className" property. You can bind to the tab key for this, but *you may not want to*.
