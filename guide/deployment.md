...
<img src="https://guide.meteor.com/images/galaxy-org-dashboard.png">

If you are following *our advice](security.html#ssl), you'll probably want to [set up SSL* on your Galaxy application with the certificate and key for your domain. The key things here are to add the `force-ssl` package and to use the Galaxy UI to add your SSL certificate.
...
<img src="https://guide.meteor.com/images/galaxy-scaling.png">
...
* The *`kadirahq/mup`* fork _(best for Meteor 1.4 or higher)_
...
<img src="https://guide.meteor.com/images/galaxy-deploying.png">
...
```
Now, we need to configure the package with our Google Analytics key (the package also supports a large variety of other providers, check out the *documentation on Atmosphere*. Pass it in as part of [_Meteor settings_](#environment):
...
<img src="https://guide.meteor.com/images/galaxy-metrics.png">
...
<img src="https://guide.meteor.com/images/galaxy-logs.png">
...
<img src="https://guide.meteor.com/images/kadira-method-latency.png">
...
<img src="https://guide.meteor.com/images/kadira-method-trace.png">
...
<img src="https://guide.meteor.com/images/kadira-observer-usage.png">
